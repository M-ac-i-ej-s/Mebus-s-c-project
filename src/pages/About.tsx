  ...
  return (
    <div className="div__about">
        ...
        <Paper elevation={3}>
            ...
            <div className="div__paragraph">
                Dawno , dawno temu, za lasami, za górami, w małej miejscowości Grabowo, żyła sobie rodzina Piaskowskich. 
                W roku 1923 przyszedł na świat ich pierworodny. Dostał na imię Jan.
            </div>
            <div className="div__paragraph">
                Jan był mały, ale bystry i od małego uczył się fachu w ojcowskiej kuźni, a także dzielnie pomagał matce w gospodarstwie. 
                Było biednie i trochę licho, ale siła w rodzinie.
            </div>
            <div className="div__paragraph">
                Któregoś pięknego lata Jan poznał Helenę. Wielka to była rewolucja dla młodego chłopaka, tym bardziej, że Helena była dziewczyną piękną, odważną i 
                co najważniejsze – zakochaną bez pamięci w przystojnym Janku. Nic więc dziwnego, iż oboje postanowili związać ze sobą swoją przyszłość. 
                Pobrali się i w roku 1945 wkroczyli dumnie do Wolnego Miasta Gdańsk. Odtąd żyli w wielkiej harmonii a dom przy ul. Skarpowej powoli zapełniał 
                się wesołym śmiechem ich dziatek .
            </div>
            <div className="div__paragraph">
                Było ciężko, jak na tamte czasy. Walka o każdy dzień zmusiła do nowatorskich przedsięwzięć, tak więc dała początek firmie przy ul. Ludowej, 
                o której wieści rozniosły się w mgnieniu oka. Jan wraz ze swoim przyjacielem Stefanem zaczął stawiać pierwsze kroki w biznesie bardzo trywialnie … 
                od pudełek do pasty do obuwia i podłogi. Kiedy interes zaczął się rozkręcać, młodzi ludzie wprowadzili jeszcze okucia do luster, a także krzyk sezonu – 
